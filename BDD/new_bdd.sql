...
CREATE TABLE IF NOT EXISTS `fond_de_placard`.`ingredients` (
  ...
  `ing_valide` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '',
...
CREATE TABLE IF NOT EXISTS `fond_de_placard`.`recipe` (
  ...
  `picture_pic_id1` INT NOT NULL COMMENT '',
  PRIMARY KEY (`rec_id`)  COMMENT '',
  UNIQUE INDEX `rec_name_UNIQUE` (`rec_name` ASC)  COMMENT '',
  INDEX `fk_recipe_picture1_idx` (`picture_pic_id1` ASC)  COMMENT '',
  CONSTRAINT `fk_recipe_picture1`
    FOREIGN KEY (`picture_pic_id1`)
...
CREATE TABLE IF NOT EXISTS `fond_de_placard`.`user` (
  ...
  `group_gro_id1` INT NOT NULL COMMENT '',
  ...
  INDEX `fk_user_group1_idx` (`group_gro_id1` ASC)  COMMENT '',
  CONSTRAINT `fk_user_group1`
    FOREIGN KEY (`group_gro_id1`)
...
-- -----------------------------------------------------
-- Table `fond_de_placard`.`recipe_has_user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fond_de_placard`.`recipe_has_user` (
  `recipe_rec_id` INT NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `fond_de_placard`.`comment` (
  ...
  `recipe_has_user_recipe_rec_id` INT NOT NULL COMMENT '',
  `recipe_has_user_user_use_id` INT NOT NULL COMMENT '',
  PRIMARY KEY (`com_id`)  COMMENT '',
  INDEX `fk_comment_recipe_has_user1_idx` (`recipe_has_user_recipe_rec_id` ASC, `recipe_has_user_user_use_id` ASC)  COMMENT '',
  CONSTRAINT `fk_comment_recipe_has_user1`
    FOREIGN KEY (`recipe_has_user_recipe_rec_id` , `recipe_has_user_user_use_id`)
    REFERENCES `fond_de_placard`.`recipe_has_user` (`recipe_rec_id` , `user_use_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
